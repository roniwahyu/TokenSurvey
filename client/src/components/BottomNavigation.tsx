        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex flex-col items-center justify-center space-y-1 px-3 py-2 rounded-xl transition-all duration-300 ease-in-out touch-target transform active:scale-95 group",
                isActive
